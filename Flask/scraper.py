...
def getGarageData():
    ...
    if len(duplicatePct) == 0:
        ...
        returnStmt = "Currently, " + str(lowestOppGarage[0]) + " has the lowest garage occupancy at " + str(lowestOppPct) + "%."
    else:
        ...
        returnStmt = "Currently, " + ', '.join(lowestOppGarages) + " garages have the lowest occupancy levels at " + duplicatePct[0] + "%."
